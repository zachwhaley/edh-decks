...
At the end of your turn, it creates X 1/1 black Fungus creature tokens that can’t block, where X is the number of times you descended that turn.
...
When they die, each one triggers:
...
The Fungi is a deck about resilience.
